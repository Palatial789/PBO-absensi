...
class Menu extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('menu/department/index', $d); // Department Page
  ...
  public function a_dept()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/department/a_dept', $d); // Add Department Page
  ...
  private function _addDept()
  {
    ...
    if ($checkId > 0) {
      ...
      redirect('menu/e_dept/'.$this->input->post('d_id'));
    }
  }
  ...
  public function e_dept($d_id)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('menu/department/e_dept', $d); // Edit Department Page
      $this->load->view('templates/footer');
    } else {
      $name = $this->input->post('d_name');
  ...
  public function shift()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/shift/index', $d); // shift Page
    $this->load->view('templates/table_footer');
  }
  public function a_shift()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/shift/a_shift', $d); // Add shift Page
    $this->load->view('templates/footer');
  }
  ...
  public function e_shift($s_id)
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/shift/e_shift', $d); // Edit shift Page
    $this->load->view('templates/footer');
  }
  ...
  public function employee()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/employee/index', $d); // Employee Page
    $this->load->view('templates/table_footer');
  }
  ...
  public function a_employee()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/employee/a_employee', $d); // Add Employee Page
    $this->load->view('templates/footer');
  }
  ...
  public function e_employee($e_id)
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/employee/e_employee', $d); // Edit Employee Page
    $this->load->view('templates/footer');
}
  ...
  public function location()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/location/index', $d);
    $this->load->view('templates/table_footer');
  }
  public function a_location()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/location/a_location', $d);
    $this->load->view('templates/footer');
  }
  ...
  public function e_location($l_id)
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/Location/e_location', $d); // Edit Location Page
    $this->load->view('templates/footer');
  }
  ...
  public function users()
  {
    ...
    $this->load->view('templates/sidebar');
    $this->load->view('templates/topbar');
    $this->load->view('menu/users/index', $d);
    $this->load->view('templates/table_footer');
  }
  ...
  public function a_users($e_id)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('menu/users/a_users', $d);
      $this->load->view('templates/footer');
    } else {
  ...
  public function e_users($username)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/sidebar');
      $this->load->view('templates/topbar');
      $this->load->view('menu/users/e_users', $d);
      $this->load->view('templates/footer');
    } else {
